...
//private _userArray = ["C_SUV_01_F","I_G_Offroad_01_armed_F","O_Truck_02_transport_F","O_Truck_02_fuel_F","O_Truck_02_box_F","O_Truck_02_Ammo_F","I_Truck_02_MRL_F","B_MBT_01_TUSK_F","B_APC_Wheeled_03_cannon_F","O_APC_Wheeled_02_rcws_v2_F","B_Heli_Light_01_F","B_Heli_Light_01_dynamicLoadout_F"];		//example
private _userArray = ["C_SUV_01_F","I_G_Offroad_01_armed_F","O_Truck_02_transport_F","O_Truck_02_fuel_F","O_Truck_02_box_F","O_Truck_02_Ammo_F","I_Truck_02_MRL_F","B_MBT_01_TUSK_F","B_APC_Wheeled_03_cannon_F","O_APC_Wheeled_02_rcws_v2_F","B_Heli_Light_01_F","B_Heli_Light_01_dynamicLoadout_F"];
...
private _cfgVehicles = if ((count _userArray) == 0) then {
    "true" configClasses (configFile >> "CfgVehicles")
} else {
    _userArray apply { configFile >> "CfgVehicles" >> _x }
};
    ...
    if (_correctClassname) then {
        ...
        if (_correctClassname) then {
			...
			if !(_parentClass in _vehParentArray) then {
				...
				private _respectLevel = _attributeArray call _calculateRespect;
